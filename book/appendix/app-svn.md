...
Since Subversion doesn't know what parts of its namespace are really branches, it
...
When you run `hg status` without any arguments, it prints the status of the entire
